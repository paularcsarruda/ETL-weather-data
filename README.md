# 🌤️ Pipeline ETL - Dados Climáticos de Recife


> Pipeline ETL automatizado para coleta, transformação e armazenamento de dados meteorológicos em tempo real da cidade de Recife.
...
Este projeto foi desenvolvido para demonstrar a construção de um **pipeline ETL completo** utilizando as melhores práticas de Engenharia de Dados.
